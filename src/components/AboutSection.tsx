  ...
  const qualities = [
    {
      icon: Award,
      title: "Искуство",
      description: "Долгогодишно искуство во јавниот сектор и локалната самоуправа"
    },
    {
      icon: Users,
      title: "Заедништво",
          ...
          <div className="slide-up">
            <div className="bg-white rounded-2xl p-8 shadow-card">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Жарко Бошкоски е долгогодишен активист и визионер за модерен и зелен Прилеп. 
                  Со богато искуство во јавниот сектор и длабока љубов кон својот град, 
                  тој се посветува на создавање на подобра иднина за сите граѓани.
                </p>
