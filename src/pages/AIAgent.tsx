          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              ...
              <p className="text-xl lg:text-2xl opacity-90 leading-relaxed mb-4">
                Жарко Бошкоски како Градоначалник ќе ни донесе вештачки интелигентен агент
              ...
              <div className="bg-campaign-yellow/20 border border-campaign-yellow/30 rounded-xl p-6 mt-6">
                <p className="text-lg font-semibold text-white">
                  Ова е најбрзото решение за искоренување на корупцијата и забрзување на процесите во Општинската администрација • Прилеп град лидер во Македонија
                </p>
              </div>
            </div>
